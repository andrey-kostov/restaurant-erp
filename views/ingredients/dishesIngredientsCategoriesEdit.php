<div class="container-fluid">
    <div class="row">
        <h2 class="card-title"> <?= $textDishesCategoriesUpdateCategory; ?> </h2>
        <form id="dishesCategoriesUpdateForm" action="<?= $root;?>dishesIngredientsCategories" method="post" enctype="multipart/form-data" class="row g-1">
            <div class="col-10">
