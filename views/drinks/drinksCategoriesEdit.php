<div class="container-fluid">
    <div class="row">
        <h2 class="card-title"> <?php echo $textDrinksCategoriesUpdateCategory; ?> </h2>
        <form id="drinksCategoriesUpdateForm" action="<?php echo $root;?>drinksCategories" method="post" enctype="multipart/form-data" class="row g-1">
            <div class="col-10">
